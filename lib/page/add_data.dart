              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    provider.buildFieldData(provider.nameController,
                        "Enter Name", false, TextInputType.name),
                    provider.buildTitle("User Email"),
                    provider.buildFieldData(provider.emailController,
                        "Enter Email", false, TextInputType.emailAddress),
                    provider.buildTitle("User Mobile"),
                    provider.buildFieldData(provider.mobileController,
                        "Enter Mobile", false, TextInputType.phone),
